...
Драг эвндв; дроп Drag and drop the ``||Агент: сделать активной ячейку||`` code block to the coding Workspace and add it to your  ``||Player:on chat command||`` code block.
